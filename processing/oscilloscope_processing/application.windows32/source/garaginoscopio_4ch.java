...
public class garaginoscopio_4ch extends PApplet {
...
public void mouseClicked() {
  ...
  if (r==1) { // retornou 1 ent\u00e3o abrir serial
    try {
      ...
      port=new Serial(this, com.ports[com.indPort], PApplet.parseInt(com.speed));
      port.bufferUntil(10); //configurado para pegar linhas inteiras
      com.conectado=true;
      com.erro=false;
    ...
    if (i>=0) { // encontrou sinal "=" (igual)  obs: i=-1 => n\u00e3o encontrou o sinal '='
      ...
      if (cmd.equals("f")) { // entra fluxo de dados - deslocar dados e armazenar no final
        ...
        if (cmd.equals("q")){ // val=100
          ...
          variasAmostras.clicado=PApplet.parseBoolean(PApplet.parseInt(val));
          ...
          println("pwmPon=",PApplet.parseFloat(val));
        }
      }
    }
    //println("cmd=",cmd);
...
class Com{
   ...
   //String speed="115200";
   String speed="250000";
   //String speeds[]={"9600","115200","speed"};
   //int portSpeed;
   ...
   public void display(){
     ...
     text("*",x+u/2,y+h/2); text(ports[indPort],x+3*u,y+h/2); text(speed,x+7*u,y+h/2); 
...
class Tela{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "garaginoscopio_4ch" };
    if (passedArgs != null) {
